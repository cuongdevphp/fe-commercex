...
export class DefaultDashboardComponent {
    ...
    themeColors = this.themeService.get().colors;
    ...
    ngOnInit(): void {
        ...
        this.themeService.data$.subscribe(
          ...
          this.dashboardService.selectedHeaderColor.subscribe(
              (data) => {
                  this.selectedHeaderColor = data;
                console.log(data, 'cuonglibagai 1');
              }
            );
    }
